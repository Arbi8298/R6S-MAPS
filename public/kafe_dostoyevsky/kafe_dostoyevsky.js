window.onload = function() {
    ...
    const f3 = document.getElementsByClassName("3f");
    ...
    const S_3f = document.getElementsByClassName("S-3f");
    ...
    var btn_bs_3f = document.getElementById("bs_3f");

    var btn_f_1f = document.getElementById("f_1f");
    var btn_f_2f = document.getElementById("f_2f");
    var btn_f_3f = document.getElementById("f_3f");
    ...
    document.getElementById("bs_3f").addEventListener("click", fn_bs_3f);

    document.getElementById("f_1f").addEventListener("click", fn_f_1f);
    document.getElementById("f_2f").addEventListener("click", fn_f_2f);
    document.getElementById("f_3f").addEventListener("click", fn_f_3f);
    ...
    function remove(){
        ...
        document.getElementById("bs_3f").removeEventListener("click", fn_bs_3f);
        ...
        document.getElementById("f_3f").removeEventListener("click", fn_f_3f);
    ...
    function update(){
        ...
        if (f_3f){
            ...
            btn_f_3f.classList.remove('pushed');
        }
        if (f_roof){
    ...
    function run_bs(){
        if(bs_none){
            ...
            for (var i = 0; i < S_3f.length; i++) {
                S_3f[i].style.display = "none";
            }
        } else {
        ...
        if(bs_3f){
            btn_bs_3f.classList.add('pushed');
            for (var i = 0; i < S_1f.length; i++) {
                S_1f[i].style.display = "none";
            }
            for (var i = 0; i < S_2fW.length; i++) {
            ...
            for (var i = 0; i < S_3f.length; i++) {
                S_3f[i].style.display = "block";
            }
        } else {
            btn_bs_3f.classList.remove('pushed');
        }
    }
