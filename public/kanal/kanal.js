window.onload = function() {
    ...
    var btn_f_b2 = document.getElementById("f_b2");
    ...
    document.getElementById("f_b2").addEventListener("click", fn_f_b2);
    ...
    function remove(){
        ...
        document.getElementById("f_b2").removeEventListener("click", fn_f_b2);
    ...
    function update(){
        if (f_b2){
            ...
            btn_f_b2.classList.remove('pushed');
        }
        if (f_b1){
