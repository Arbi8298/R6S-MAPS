window.onload = function() {
    ...
    const S_1fN = document.getElementsByClassName("S-1fN");
    ...
    var btn_bs_1fN = document.getElementById("bs_1fN");
    var btn_bs_1fS = document.getElementById("bs_1fS");
    ...
    document.getElementById("bs_1fN").addEventListener("click", fn_bs_1fN);
    document.getElementById("bs_1fS").addEventListener("click", fn_bs_1fS);
    ...
    function remove(){
        ...
        document.getElementById("bs_1fN").removeEventListener("click", fn_bs_1fN);
        document.getElementById("bs_1fS").removeEventListener("click", fn_bs_1fS);
    ...
    function run_bs(){
        if(bs_none){
            ...
            for (var i = 0; i < S_1fN.length; i++) {
                S_1fN[i].style.display = "none";
            }
            for (var i = 0; i < S_1fS.length; i++) {
                S_1fS[i].style.display = "none";
            }
        ...
        if(bs_1fN){
            btn_bs_1fN.classList.add('pushed');
            for (var i = 0; i < S_b1.length; i++) {
                S_b1[i].style.display = "none";
            }
            for (var i = 0; i < S_1fN.length; i++) {
                S_1fN[i].style.display = "block";
            }
            for (var i = 0; i < S_1fS.length; i++) {
                S_1fS[i].style.display = "none";
            }
            ...
            btn_bs_1fN.classList.remove('pushed');
        }
        if(bs_1fS){
            btn_bs_1fS.classList.add('pushed');
            for (var i = 0; i < S_b1.length; i++) {
                S_b1[i].style.display = "none";
            }
            for (var i = 0; i < S_1fN.length; i++) {
            ...
            for (var i = 0; i < S_1fS.length; i++) {
                S_1fS[i].style.display = "block";
            }
            for (var i = 0; i < S_2f.length; i++) {
                S_2f[i].style.display = "none";
            }
        } else {
            btn_bs_1fS.classList.remove('pushed');
        }
        if(bs_2f){
